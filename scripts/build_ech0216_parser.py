...
SCHEMA_URLS = {
    # "http://www.ech.ch/xmlns/eCH-0216/2/eCH-0216-2-0.xsd": "ech_0216_2_0.xsd", Not online yet
...
if __name__ == "__main__":
    workdir = "ebau_gwr/core/xsd"
    force = "--force" in sys.argv

    ns_to_file = fetch_schema_files(workdir, force)

    # TODO: can be removed as soon as 0216 v2 is available online
    ns_to_file[
        "http://www.ech.ch/xmlns/eCH-0216/2"
    ] = "ebau_gwr/core/xsd/ech_0216_2_0.xsd"
    ...
    modules = [
        (
            ...
            fn,
            "-m",
            fn.replace("ebau_gwr/core/xsd/", "ebau_gwr.core.schema.").replace(
                ".xsd", ""
            ),
        )
    ...
    subprocess.check_call(["pyxbgen", *module_args])
