# ./ebau_gwr/core/schema/ech_0058_5_0.py
# -*- coding: utf-8 -*-
# PyXB bindings for NM:0a977b0d5d16d2765b30271df543b1ee709b7a8f
# Generated 2020-12-04 11:54:01.098856 by PyXB version 1.2.6 using Python 3.6.12.final.0
...
Namespace = pyxb.namespace.NamespaceForURI(
    "http://www.ech.ch/xmlns/eCH-0058/5", create_if_missing=True
)
...
class STD_ANON(pyxb.binding.datatypes.token):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        "/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 8, 4
    )
    _Documentation = None
...
class STD_ANON_(pyxb.binding.datatypes.token):
    ...
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location(
        "/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 16, 4
    )
    _Documentation = None
...
class actionType(pyxb.binding.datatypes.string, pyxb.binding.basis.enumeration_mixin):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        "/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 56, 1
    )
    _Documentation = None


actionType._CF_minLength = pyxb.binding.facets.CF_minLength(
    value=pyxb.binding.datatypes.nonNegativeInteger(1)
)
...
actionType.n10 = actionType._CF_enumeration.addEnumeration(
    unicode_value="10", tag="n10"
)
actionType.n12 = actionType._CF_enumeration.addEnumeration(
    unicode_value="12", tag="n12"
)
actionType._InitializeFacetMap(
    actionType._CF_minLength, actionType._CF_maxLength, actionType._CF_enumeration
)
...
class eventDateType(pyxb.binding.datatypes.date):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        "/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 78, 1
    )
    _Documentation = None
...
class messageIdType(pyxb.binding.datatypes.token):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        "/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 81, 1
    )
    _Documentation = None


messageIdType._CF_minLength = pyxb.binding.facets.CF_minLength(
    value=pyxb.binding.datatypes.nonNegativeInteger(1)
)
messageIdType._CF_maxLength = pyxb.binding.facets.CF_maxLength(
    value=pyxb.binding.datatypes.nonNegativeInteger(36)
)
messageIdType._InitializeFacetMap(
    messageIdType._CF_minLength, messageIdType._CF_maxLength
)
...
class subMessageTypeType(pyxb.binding.datatypes.token):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        "/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 87, 1
    )
    _Documentation = None


subMessageTypeType._CF_minLength = pyxb.binding.facets.CF_minLength(
    value=pyxb.binding.datatypes.nonNegativeInteger(1)
)
subMessageTypeType._CF_maxLength = pyxb.binding.facets.CF_maxLength(
    value=pyxb.binding.datatypes.nonNegativeInteger(36)
)
subMessageTypeType._InitializeFacetMap(
    subMessageTypeType._CF_minLength, subMessageTypeType._CF_maxLength
)
...
class messageTypeType(pyxb.binding.datatypes.anyURI):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        "/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 93, 1
    )
    _Documentation = None
...
class declarationLocalReferenceType(pyxb.binding.datatypes.token):
    ...
    _ExpandedName = pyxb.namespace.ExpandedName(
        Namespace, "declarationLocalReferenceType"
    )
    _XSDLocation = pyxb.utils.utility.Location(
        "/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 96, 1
    )
    _Documentation = None


declarationLocalReferenceType._CF_minLength = pyxb.binding.facets.CF_minLength(
    value=pyxb.binding.datatypes.nonNegativeInteger(1)
)
declarationLocalReferenceType._CF_maxLength = pyxb.binding.facets.CF_maxLength(
    value=pyxb.binding.datatypes.nonNegativeInteger(100)
)
declarationLocalReferenceType._InitializeFacetMap(
    declarationLocalReferenceType._CF_minLength,
    declarationLocalReferenceType._CF_maxLength,
)
Namespace.addCategoryObject(
    "typeBinding", "declarationLocalReferenceType", declarationLocalReferenceType
)
...
class participantIdType(pyxb.binding.datatypes.anyURI):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        "/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 102, 1
    )
    _Documentation = None
...
class businessReferenceIdType(pyxb.binding.datatypes.token):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        "/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 105, 1
    )
    _Documentation = None


businessReferenceIdType._CF_minLength = pyxb.binding.facets.CF_minLength(
    value=pyxb.binding.datatypes.nonNegativeInteger(1)
)
businessReferenceIdType._CF_maxLength = pyxb.binding.facets.CF_maxLength(
    value=pyxb.binding.datatypes.nonNegativeInteger(50)
)
businessReferenceIdType._InitializeFacetMap(
    businessReferenceIdType._CF_minLength, businessReferenceIdType._CF_maxLength
)
Namespace.addCategoryObject(
    "typeBinding", "businessReferenceIdType", businessReferenceIdType
)
...
class subjectType(pyxb.binding.datatypes.token):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        "/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 111, 1
    )
    _Documentation = None


subjectType._CF_minLength = pyxb.binding.facets.CF_minLength(
    value=pyxb.binding.datatypes.nonNegativeInteger(1)
)
subjectType._CF_maxLength = pyxb.binding.facets.CF_maxLength(
    value=pyxb.binding.datatypes.nonNegativeInteger(100)
)
subjectType._InitializeFacetMap(subjectType._CF_minLength, subjectType._CF_maxLength)
...
class commentType(pyxb.binding.datatypes.token):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        "/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 117, 1
    )
    _Documentation = None


commentType._CF_minLength = pyxb.binding.facets.CF_minLength(
    value=pyxb.binding.datatypes.nonNegativeInteger(1)
)
commentType._CF_maxLength = pyxb.binding.facets.CF_maxLength(
    value=pyxb.binding.datatypes.nonNegativeInteger(250)
)
commentType._InitializeFacetMap(commentType._CF_minLength, commentType._CF_maxLength)
...
class uniqueIdDeliveryType(pyxb.binding.datatypes.token):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        "/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 123, 1
    )
    _Documentation = None


uniqueIdDeliveryType._CF_minLength = pyxb.binding.facets.CF_minLength(
    value=pyxb.binding.datatypes.nonNegativeInteger(1)
)
uniqueIdDeliveryType._CF_maxLength = pyxb.binding.facets.CF_maxLength(
    value=pyxb.binding.datatypes.nonNegativeInteger(50)
)
uniqueIdDeliveryType._InitializeFacetMap(
    uniqueIdDeliveryType._CF_minLength, uniqueIdDeliveryType._CF_maxLength
)
...
class uniqueIdBusinessTransactionType(pyxb.binding.datatypes.token):
    ...
    _ExpandedName = pyxb.namespace.ExpandedName(
        Namespace, "uniqueIdBusinessTransactionType"
    )
    _XSDLocation = pyxb.utils.utility.Location(
        "/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 129, 1
    )
    _Documentation = None


uniqueIdBusinessTransactionType._CF_minLength = pyxb.binding.facets.CF_minLength(
    value=pyxb.binding.datatypes.nonNegativeInteger(1)
)
uniqueIdBusinessTransactionType._CF_maxLength = pyxb.binding.facets.CF_maxLength(
    value=pyxb.binding.datatypes.nonNegativeInteger(50)
)
uniqueIdBusinessTransactionType._InitializeFacetMap(
    uniqueIdBusinessTransactionType._CF_minLength,
    uniqueIdBusinessTransactionType._CF_maxLength,
)
Namespace.addCategoryObject(
    "typeBinding", "uniqueIdBusinessTransactionType", uniqueIdBusinessTransactionType
)
...
class totalNumberOfPackagesType(pyxb.binding.datatypes.nonNegativeInteger):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        "/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 135, 1
    )
    _Documentation = None


totalNumberOfPackagesType._CF_minInclusive = pyxb.binding.facets.CF_minInclusive(
    value_datatype=totalNumberOfPackagesType,
    value=pyxb.binding.datatypes.nonNegativeInteger(1),
)
totalNumberOfPackagesType._CF_maxInclusive = pyxb.binding.facets.CF_maxInclusive(
    value_datatype=totalNumberOfPackagesType,
    value=pyxb.binding.datatypes.nonNegativeInteger(9999),
)
totalNumberOfPackagesType._InitializeFacetMap(
    totalNumberOfPackagesType._CF_minInclusive,
    totalNumberOfPackagesType._CF_maxInclusive,
)
Namespace.addCategoryObject(
    "typeBinding", "totalNumberOfPackagesType", totalNumberOfPackagesType
)
...
class numberOfActualPackageType(pyxb.binding.datatypes.nonNegativeInteger):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        "/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 141, 1
    )
    _Documentation = None


numberOfActualPackageType._CF_minInclusive = pyxb.binding.facets.CF_minInclusive(
    value_datatype=numberOfActualPackageType,
    value=pyxb.binding.datatypes.nonNegativeInteger(1),
)
numberOfActualPackageType._CF_maxInclusive = pyxb.binding.facets.CF_maxInclusive(
    value_datatype=numberOfActualPackageType,
    value=pyxb.binding.datatypes.nonNegativeInteger(9999),
)
numberOfActualPackageType._InitializeFacetMap(
    numberOfActualPackageType._CF_minInclusive,
    numberOfActualPackageType._CF_maxInclusive,
)
Namespace.addCategoryObject(
    "typeBinding", "numberOfActualPackageType", numberOfActualPackageType
)
...
class testDeliveryFlagType(pyxb.binding.datatypes.boolean):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        "/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 147, 1
    )
    _Documentation = None
...
class messageDateType(pyxb.binding.datatypes.dateTime):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        "/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 150, 1
    )
    _Documentation = None
...
class businessProcessIdType(pyxb.binding.datatypes.token):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        "/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 153, 1
    )
    _Documentation = None


businessProcessIdType._CF_minLength = pyxb.binding.facets.CF_minLength(
    value=pyxb.binding.datatypes.nonNegativeInteger(1)
)
businessProcessIdType._CF_maxLength = pyxb.binding.facets.CF_maxLength(
    value=pyxb.binding.datatypes.nonNegativeInteger(128)
)
businessProcessIdType._InitializeFacetMap(
    businessProcessIdType._CF_minLength, businessProcessIdType._CF_maxLength
)
Namespace.addCategoryObject(
    "typeBinding", "businessProcessIdType", businessProcessIdType
)
...
class businessCaseClosedType(pyxb.binding.datatypes.boolean):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        "/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 159, 1
    )
    _Documentation = None
...
Namespace.addCategoryObject(
    "typeBinding", "businessCaseClosedType", businessCaseClosedType
)
...
class responseExpectedType(pyxb.binding.datatypes.boolean):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        "/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 162, 1
    )
    _Documentation = None
...
class STD_ANON_2(pyxb.binding.datatypes.token):
    ...
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location(
        "/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 168, 4
    )
    _Documentation = None
...
class STD_ANON_3(pyxb.binding.datatypes.token):
    ...
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location(
        "/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 176, 4
    )
    _Documentation = None
...
class STD_ANON_4(pyxb.binding.datatypes.token):
    ...
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location(
        "/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 184, 4
    )
    _Documentation = None
...
class namedMetaDataType(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        "/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 5, 1
    )
    _ElementMap = {}
    _AttributeMap = {}
    ...
    __metaDataName = pyxb.binding.content.ElementDeclaration(
        ...
        "metaDataName",
        "__httpwww_ech_chxmlnseCH_00585_namedMetaDataType_httpwww_ech_chxmlnseCH_00585metaDataName",
        False,
        pyxb.utils.utility.Location("/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 7, 3),
    )
    ...
    __metaDataValue = pyxb.binding.content.ElementDeclaration(
        ...
        "metaDataValue",
        "__httpwww_ech_chxmlnseCH_00585_namedMetaDataType_httpwww_ech_chxmlnseCH_00585metaDataValue",
        False,
        pyxb.utils.utility.Location("/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 15, 3),
    )
...
class headerType(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        "/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 25, 1
    )
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    ...
    __senderId = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(Namespace, "senderId"),
        "senderId",
        "__httpwww_ech_chxmlnseCH_00585_headerType_httpwww_ech_chxmlnseCH_00585senderId",
        False,
        pyxb.utils.utility.Location("/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 27, 3),
    )
    ...
    __originalSenderId = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(Namespace, "originalSenderId"),
        "originalSenderId",
        "__httpwww_ech_chxmlnseCH_00585_headerType_httpwww_ech_chxmlnseCH_00585originalSenderId",
        False,
        pyxb.utils.utility.Location("/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 28, 3),
    )

    originalSenderId = property(
        __originalSenderId.value, __originalSenderId.set, None, None
    )

    # Element {http://www.ech.ch/xmlns/eCH-0058/5}declarationLocalReference uses Python identifier declarationLocalReference
    __declarationLocalReference = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(Namespace, "declarationLocalReference"),
        "declarationLocalReference",
        "__httpwww_ech_chxmlnseCH_00585_headerType_httpwww_ech_chxmlnseCH_00585declarationLocalReference",
        False,
        pyxb.utils.utility.Location("/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 29, 3),
    )

    declarationLocalReference = property(
        __declarationLocalReference.value, __declarationLocalReference.set, None, None
    )

    # Element {http://www.ech.ch/xmlns/eCH-0058/5}recipientId uses Python identifier recipientId
    __recipientId = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(Namespace, "recipientId"),
        "recipientId",
        "__httpwww_ech_chxmlnseCH_00585_headerType_httpwww_ech_chxmlnseCH_00585recipientId",
        True,
        pyxb.utils.utility.Location("/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 30, 3),
    )
    ...
    __messageId = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(Namespace, "messageId"),
        "messageId",
        "__httpwww_ech_chxmlnseCH_00585_headerType_httpwww_ech_chxmlnseCH_00585messageId",
        False,
        pyxb.utils.utility.Location("/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 31, 3),
    )
    ...
    __referenceMessageId = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(Namespace, "referenceMessageId"),
        "referenceMessageId",
        "__httpwww_ech_chxmlnseCH_00585_headerType_httpwww_ech_chxmlnseCH_00585referenceMessageId",
        False,
        pyxb.utils.utility.Location("/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 32, 3),
    )

    referenceMessageId = property(
        __referenceMessageId.value, __referenceMessageId.set, None, None
    )

    # Element {http://www.ech.ch/xmlns/eCH-0058/5}businessProcessId uses Python identifier businessProcessId
    __businessProcessId = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(Namespace, "businessProcessId"),
        "businessProcessId",
        "__httpwww_ech_chxmlnseCH_00585_headerType_httpwww_ech_chxmlnseCH_00585businessProcessId",
        False,
        pyxb.utils.utility.Location("/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 33, 3),
    )

    businessProcessId = property(
        __businessProcessId.value, __businessProcessId.set, None, None
    )

    # Element {http://www.ech.ch/xmlns/eCH-0058/5}ourBusinessReferenceId uses Python identifier ourBusinessReferenceId
    __ourBusinessReferenceId = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(Namespace, "ourBusinessReferenceId"),
        "ourBusinessReferenceId",
        "__httpwww_ech_chxmlnseCH_00585_headerType_httpwww_ech_chxmlnseCH_00585ourBusinessReferenceId",
        False,
        pyxb.utils.utility.Location("/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 34, 3),
    )

    ourBusinessReferenceId = property(
        __ourBusinessReferenceId.value, __ourBusinessReferenceId.set, None, None
    )

    # Element {http://www.ech.ch/xmlns/eCH-0058/5}yourBusinessReferenceId uses Python identifier yourBusinessReferenceId
    __yourBusinessReferenceId = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(Namespace, "yourBusinessReferenceId"),
        "yourBusinessReferenceId",
        "__httpwww_ech_chxmlnseCH_00585_headerType_httpwww_ech_chxmlnseCH_00585yourBusinessReferenceId",
        False,
        pyxb.utils.utility.Location("/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 35, 3),
    )

    yourBusinessReferenceId = property(
        __yourBusinessReferenceId.value, __yourBusinessReferenceId.set, None, None
    )

    # Element {http://www.ech.ch/xmlns/eCH-0058/5}uniqueIdBusinessTransaction uses Python identifier uniqueIdBusinessTransaction
    __uniqueIdBusinessTransaction = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(Namespace, "uniqueIdBusinessTransaction"),
        "uniqueIdBusinessTransaction",
        "__httpwww_ech_chxmlnseCH_00585_headerType_httpwww_ech_chxmlnseCH_00585uniqueIdBusinessTransaction",
        False,
        pyxb.utils.utility.Location("/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 36, 3),
    )

    uniqueIdBusinessTransaction = property(
        __uniqueIdBusinessTransaction.value,
        __uniqueIdBusinessTransaction.set,
        None,
        None,
    )

    # Element {http://www.ech.ch/xmlns/eCH-0058/5}messageType uses Python identifier messageType
    __messageType = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(Namespace, "messageType"),
        "messageType",
        "__httpwww_ech_chxmlnseCH_00585_headerType_httpwww_ech_chxmlnseCH_00585messageType",
        False,
        pyxb.utils.utility.Location("/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 37, 3),
    )
    ...
    __subMessageType = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(Namespace, "subMessageType"),
        "subMessageType",
        "__httpwww_ech_chxmlnseCH_00585_headerType_httpwww_ech_chxmlnseCH_00585subMessageType",
        False,
        pyxb.utils.utility.Location("/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 38, 3),
    )
    ...
    __sendingApplication = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(Namespace, "sendingApplication"),
        "sendingApplication",
        "__httpwww_ech_chxmlnseCH_00585_headerType_httpwww_ech_chxmlnseCH_00585sendingApplication",
        False,
        pyxb.utils.utility.Location("/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 39, 3),
    )

    sendingApplication = property(
        __sendingApplication.value, __sendingApplication.set, None, None
    )

    # Element {http://www.ech.ch/xmlns/eCH-0058/5}partialDelivery uses Python identifier partialDelivery
    __partialDelivery = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(Namespace, "partialDelivery"),
        "partialDelivery",
        "__httpwww_ech_chxmlnseCH_00585_headerType_httpwww_ech_chxmlnseCH_00585partialDelivery",
        False,
        pyxb.utils.utility.Location("/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 40, 3),
    )

    partialDelivery = property(
        __partialDelivery.value, __partialDelivery.set, None, None
    )
    ...
    __subject = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(Namespace, "subject"),
        "subject",
        "__httpwww_ech_chxmlnseCH_00585_headerType_httpwww_ech_chxmlnseCH_00585subject",
        False,
        pyxb.utils.utility.Location("/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 41, 3),
    )
    ...
    __comment = pyxb.binding.content.ElementDeclaration(
        ...
        "comment",
        "__httpwww_ech_chxmlnseCH_00585_headerType_httpwww_ech_chxmlnseCH_00585comment",
        False,
        pyxb.utils.utility.Location("/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 42, 3),
    )
    ...
    __messageDate = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(Namespace, "messageDate"),
        "messageDate",
        "__httpwww_ech_chxmlnseCH_00585_headerType_httpwww_ech_chxmlnseCH_00585messageDate",
        False,
        pyxb.utils.utility.Location("/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 43, 3),
    )
    ...
    __initialMessageDate = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(Namespace, "initialMessageDate"),
        "initialMessageDate",
        "__httpwww_ech_chxmlnseCH_00585_headerType_httpwww_ech_chxmlnseCH_00585initialMessageDate",
        False,
        pyxb.utils.utility.Location("/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 44, 3),
    )

    initialMessageDate = property(
        __initialMessageDate.value, __initialMessageDate.set, None, None
    )
    ...
    __eventDate = pyxb.binding.content.ElementDeclaration(
        ...
        "eventDate",
        "__httpwww_ech_chxmlnseCH_00585_headerType_httpwww_ech_chxmlnseCH_00585eventDate",
        False,
        pyxb.utils.utility.Location("/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 45, 3),
    )
    ...
    __modificationDate = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(Namespace, "modificationDate"),
        "modificationDate",
        "__httpwww_ech_chxmlnseCH_00585_headerType_httpwww_ech_chxmlnseCH_00585modificationDate",
        False,
        pyxb.utils.utility.Location("/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 46, 3),
    )

    modificationDate = property(
        __modificationDate.value, __modificationDate.set, None, None
    )
    ...
    __action = pyxb.binding.content.ElementDeclaration(
        ...
        "action",
        "__httpwww_ech_chxmlnseCH_00585_headerType_httpwww_ech_chxmlnseCH_00585action",
        False,
        pyxb.utils.utility.Location("/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 47, 3),
    )
    ...
    __attachment = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(Namespace, "attachment"),
        "attachment",
        "__httpwww_ech_chxmlnseCH_00585_headerType_httpwww_ech_chxmlnseCH_00585attachment",
        True,
        pyxb.utils.utility.Location("/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 48, 3),
    )
    ...
    __testDeliveryFlag = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(Namespace, "testDeliveryFlag"),
        "testDeliveryFlag",
        "__httpwww_ech_chxmlnseCH_00585_headerType_httpwww_ech_chxmlnseCH_00585testDeliveryFlag",
        False,
        pyxb.utils.utility.Location("/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 49, 3),
    )

    testDeliveryFlag = property(
        __testDeliveryFlag.value, __testDeliveryFlag.set, None, None
    )

    # Element {http://www.ech.ch/xmlns/eCH-0058/5}responseExpected uses Python identifier responseExpected
    __responseExpected = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(Namespace, "responseExpected"),
        "responseExpected",
        "__httpwww_ech_chxmlnseCH_00585_headerType_httpwww_ech_chxmlnseCH_00585responseExpected",
        False,
        pyxb.utils.utility.Location("/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 50, 3),
    )

    responseExpected = property(
        __responseExpected.value, __responseExpected.set, None, None
    )

    # Element {http://www.ech.ch/xmlns/eCH-0058/5}businessCaseClosed uses Python identifier businessCaseClosed
    __businessCaseClosed = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(Namespace, "businessCaseClosed"),
        "businessCaseClosed",
        "__httpwww_ech_chxmlnseCH_00585_headerType_httpwww_ech_chxmlnseCH_00585businessCaseClosed",
        False,
        pyxb.utils.utility.Location("/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 51, 3),
    )

    businessCaseClosed = property(
        __businessCaseClosed.value, __businessCaseClosed.set, None, None
    )
    ...
    __namedMetaData = pyxb.binding.content.ElementDeclaration(
        ...
        True,
        pyxb.utils.utility.Location("/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 52, 3),
    )
    ...
    __extension = pyxb.binding.content.ElementDeclaration(
        ...
        "extension",
        "__httpwww_ech_chxmlnseCH_00585_headerType_httpwww_ech_chxmlnseCH_00585extension",
        False,
        pyxb.utils.utility.Location("/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 53, 3),
    )
...
class partialDeliveryType(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        "/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 71, 1
    )
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    ...
    __uniqueIdDelivery = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(Namespace, "uniqueIdDelivery"),
        "uniqueIdDelivery",
        "__httpwww_ech_chxmlnseCH_00585_partialDeliveryType_httpwww_ech_chxmlnseCH_00585uniqueIdDelivery",
        False,
        pyxb.utils.utility.Location("/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 73, 3),
    )

    uniqueIdDelivery = property(
        __uniqueIdDelivery.value, __uniqueIdDelivery.set, None, None
    )

    # Element {http://www.ech.ch/xmlns/eCH-0058/5}totalNumberOfPackages uses Python identifier totalNumberOfPackages
    __totalNumberOfPackages = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(Namespace, "totalNumberOfPackages"),
        "totalNumberOfPackages",
        "__httpwww_ech_chxmlnseCH_00585_partialDeliveryType_httpwww_ech_chxmlnseCH_00585totalNumberOfPackages",
        False,
        pyxb.utils.utility.Location("/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 74, 3),
    )

    totalNumberOfPackages = property(
        __totalNumberOfPackages.value, __totalNumberOfPackages.set, None, None
    )

    # Element {http://www.ech.ch/xmlns/eCH-0058/5}numberOfActualPackage uses Python identifier numberOfActualPackage
    __numberOfActualPackage = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(Namespace, "numberOfActualPackage"),
        ...
        False,
        pyxb.utils.utility.Location("/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 75, 3),
    )

    numberOfActualPackage = property(
        __numberOfActualPackage.value, __numberOfActualPackage.set, None, None
    )
...
class sendingApplicationType(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        "/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 165, 1
    )
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    ...
    __manufacturer = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(Namespace, "manufacturer"),
        "manufacturer",
        "__httpwww_ech_chxmlnseCH_00585_sendingApplicationType_httpwww_ech_chxmlnseCH_00585manufacturer",
        False,
        pyxb.utils.utility.Location("/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 167, 3),
    )
    ...
    __product = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(Namespace, "product"),
        "product",
        "__httpwww_ech_chxmlnseCH_00585_sendingApplicationType_httpwww_ech_chxmlnseCH_00585product",
        False,
        pyxb.utils.utility.Location("/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 175, 3),
    )
    ...
    __productVersion = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(Namespace, "productVersion"),
        "productVersion",
        "__httpwww_ech_chxmlnseCH_00585_sendingApplicationType_httpwww_ech_chxmlnseCH_00585productVersion",
        False,
        pyxb.utils.utility.Location("/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 183, 3),
    )
...
Namespace.addCategoryObject(
    "typeBinding", "sendingApplicationType", sendingApplicationType
)
...
class infoType(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        "/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 193, 1
    )
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    ...
    __positiveReport = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(Namespace, "positiveReport"),
        "positiveReport",
        "__httpwww_ech_chxmlnseCH_00585_infoType_httpwww_ech_chxmlnseCH_00585positiveReport",
        False,
        pyxb.utils.utility.Location("/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 195, 3),
    )
    ...
    __negativeReport = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(Namespace, "negativeReport"),
        "negativeReport",
        "__httpwww_ech_chxmlnseCH_00585_infoType_httpwww_ech_chxmlnseCH_00585negativeReport",
        False,
        pyxb.utils.utility.Location("/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 203, 3),
    )
...
class CTD_ANON(pyxb.binding.basis.complexTypeDefinition):
    ...
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location(
        "/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 196, 4
    )
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    ...
    __notice = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(Namespace, "notice"),
        "notice",
        "__httpwww_ech_chxmlnseCH_00585_CTD_ANON_httpwww_ech_chxmlnseCH_00585notice",
        False,
        pyxb.utils.utility.Location("/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 198, 6),
    )
    ...
    __data = pyxb.binding.content.ElementDeclaration(
        ...
        "data",
        "__httpwww_ech_chxmlnseCH_00585_CTD_ANON_httpwww_ech_chxmlnseCH_00585data",
        False,
        pyxb.utils.utility.Location("/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 199, 6),
    )

    data = property(__data.value, __data.set, None, None)

    _ElementMap.update({__notice.name(): __notice, __data.name(): __data})
    _AttributeMap.update({})
...
class CTD_ANON_(pyxb.binding.basis.complexTypeDefinition):
    ...
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location(
        "/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 204, 4
    )
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    ...
    __notice = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(Namespace, "notice"),
        "notice",
        "__httpwww_ech_chxmlnseCH_00585_CTD_ANON__httpwww_ech_chxmlnseCH_00585notice",
        False,
        pyxb.utils.utility.Location("/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 206, 6),
    )
    ...
    __data = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(Namespace, "data"),
        "data",
        "__httpwww_ech_chxmlnseCH_00585_CTD_ANON__httpwww_ech_chxmlnseCH_00585data",
        False,
        pyxb.utils.utility.Location("/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 207, 6),
    )
...
class CTD_ANON_2(pyxb.binding.basis.complexTypeDefinition):
    ...
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location(
        "/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 214, 2
    )
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    ...
    __header = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(Namespace, "header"),
        "header",
        "__httpwww_ech_chxmlnseCH_00585_CTD_ANON_2_httpwww_ech_chxmlnseCH_00585header",
        False,
        pyxb.utils.utility.Location("/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 216, 4),
    )
    ...
    __info = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(Namespace, "info"),
        "info",
        "__httpwww_ech_chxmlnseCH_00585_CTD_ANON_2_httpwww_ech_chxmlnseCH_00585info",
        False,
        pyxb.utils.utility.Location("/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 217, 4),
    )

    info = property(__info.value, __info.set, None, None)

    _ElementMap.update({__header.name(): __header, __info.name(): __info})
    _AttributeMap.update({})
...
eventReport = pyxb.binding.basis.element(
    pyxb.namespace.ExpandedName(Namespace, "eventReport"),
    CTD_ANON_2,
    location=pyxb.utils.utility.Location(
        "/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 213, 1
    ),
)
Namespace.addCategoryObject(
    "elementBinding", eventReport.name().localName(), eventReport
)

header = pyxb.binding.basis.element(
    pyxb.namespace.ExpandedName(Namespace, "header"),
    headerType,
    location=pyxb.utils.utility.Location(
        "/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 221, 1
    ),
)
...
namedMetaDataType._AddElement(
    pyxb.binding.basis.element(
        ...
        location=pyxb.utils.utility.Location(
            "/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 7, 3
        ),
    )
)
...
namedMetaDataType._AddElement(
    pyxb.binding.basis.element(
        ...
        scope=namedMetaDataType,
        location=pyxb.utils.utility.Location(
            "/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 15, 3
        ),
    )
)
...
headerType._AddElement(
    pyxb.binding.basis.element(
        pyxb.namespace.ExpandedName(Namespace, "senderId"),
        participantIdType,
        scope=headerType,
        location=pyxb.utils.utility.Location(
            "/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 27, 3
        ),
    )
)
...
headerType._AddElement(
    pyxb.binding.basis.element(
        ...
        scope=headerType,
        location=pyxb.utils.utility.Location(
            "/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 28, 3
        ),
    )
)
...
headerType._AddElement(
    pyxb.binding.basis.element(
        ...
        scope=headerType,
        location=pyxb.utils.utility.Location(
            "/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 29, 3
        ),
    )
)
...
headerType._AddElement(
    pyxb.binding.basis.element(
        ...
        scope=headerType,
        location=pyxb.utils.utility.Location(
            "/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 30, 3
        ),
    )
)
...
headerType._AddElement(
    pyxb.binding.basis.element(
        ...
        scope=headerType,
        location=pyxb.utils.utility.Location(
            "/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 31, 3
        ),
    )
)
...
headerType._AddElement(
    pyxb.binding.basis.element(
        ...
        scope=headerType,
        location=pyxb.utils.utility.Location(
            "/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 32, 3
        ),
    )
)
...
headerType._AddElement(
    pyxb.binding.basis.element(
        pyxb.namespace.ExpandedName(Namespace, "businessProcessId"),
        businessProcessIdType,
        scope=headerType,
        location=pyxb.utils.utility.Location(
            "/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 33, 3
        ),
    )
)
...
headerType._AddElement(
    pyxb.binding.basis.element(
        pyxb.namespace.ExpandedName(Namespace, "ourBusinessReferenceId"),
        businessReferenceIdType,
        scope=headerType,
        location=pyxb.utils.utility.Location(
            "/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 34, 3
        ),
    )
)
...
headerType._AddElement(
    pyxb.binding.basis.element(
        ...
        scope=headerType,
        location=pyxb.utils.utility.Location(
            "/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 35, 3
        ),
    )
)
...
headerType._AddElement(
    pyxb.binding.basis.element(
        ...
        scope=headerType,
        location=pyxb.utils.utility.Location(
            "/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 36, 3
        ),
    )
)
...
headerType._AddElement(
    pyxb.binding.basis.element(
        ...
        scope=headerType,
        location=pyxb.utils.utility.Location(
            "/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 37, 3
        ),
    )
)
...
headerType._AddElement(
    pyxb.binding.basis.element(
        ...
        scope=headerType,
        location=pyxb.utils.utility.Location(
            "/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 38, 3
        ),
    )
)
...
headerType._AddElement(
    pyxb.binding.basis.element(
        ...
        scope=headerType,
        location=pyxb.utils.utility.Location(
            "/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 39, 3
        ),
    )
)
...
headerType._AddElement(
    pyxb.binding.basis.element(
        ...
        scope=headerType,
        location=pyxb.utils.utility.Location(
            "/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 40, 3
        ),
    )
)
...
headerType._AddElement(
    pyxb.binding.basis.element(
        ...
        scope=headerType,
        location=pyxb.utils.utility.Location(
            "/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 41, 3
        ),
    )
)
...
headerType._AddElement(
    pyxb.binding.basis.element(
        ...
        scope=headerType,
        location=pyxb.utils.utility.Location(
            "/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 42, 3
        ),
    )
)
...
headerType._AddElement(
    pyxb.binding.basis.element(
        ...
        scope=headerType,
        location=pyxb.utils.utility.Location(
            "/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 43, 3
        ),
    )
)
...
headerType._AddElement(
    pyxb.binding.basis.element(
        ...
        scope=headerType,
        location=pyxb.utils.utility.Location(
            "/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 44, 3
        ),
    )
)
...
headerType._AddElement(
    pyxb.binding.basis.element(
        ...
        scope=headerType,
        location=pyxb.utils.utility.Location(
            "/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 45, 3
        ),
    )
)
...
headerType._AddElement(
    pyxb.binding.basis.element(
        ...
        scope=headerType,
        location=pyxb.utils.utility.Location(
            "/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 46, 3
        ),
    )
)
...
headerType._AddElement(
    pyxb.binding.basis.element(
        ...
        scope=headerType,
        location=pyxb.utils.utility.Location(
            "/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 47, 3
        ),
    )
)
...
headerType._AddElement(
    pyxb.binding.basis.element(
        ...
        scope=headerType,
        location=pyxb.utils.utility.Location(
            "/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 48, 3
        ),
    )
)
...
headerType._AddElement(
    pyxb.binding.basis.element(
        ...
        scope=headerType,
        location=pyxb.utils.utility.Location(
            "/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 49, 3
        ),
    )
)
...
headerType._AddElement(
    pyxb.binding.basis.element(
        ...
        scope=headerType,
        location=pyxb.utils.utility.Location(
            "/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 50, 3
        ),
    )
)
...
headerType._AddElement(
    pyxb.binding.basis.element(
        pyxb.namespace.ExpandedName(Namespace, "businessCaseClosed"),
        businessCaseClosedType,
        scope=headerType,
        location=pyxb.utils.utility.Location(
            "/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 51, 3
        ),
    )
)
...
headerType._AddElement(
    pyxb.binding.basis.element(
        ...
        scope=headerType,
        location=pyxb.utils.utility.Location(
            "/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 52, 3
        ),
    )
)
...
headerType._AddElement(
    pyxb.binding.basis.element(
        ...
        scope=headerType,
        location=pyxb.utils.utility.Location(
            "/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 53, 3
        ),
    )
)
...
def _BuildAutomaton_():
    ...
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        headerType._UseForTag(pyxb.namespace.ExpandedName(Namespace, "senderId")),
        pyxb.utils.utility.Location("/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 27, 3),
    )
    st_0 = fac.State(
        symbol,
    ...
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        headerType._UseForTag(pyxb.namespace.ExpandedName(Namespace, "recipientId")),
        pyxb.utils.utility.Location("/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 30, 3),
    )
    st_3 = fac.State(
        symbol,
    ...
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        headerType._UseForTag(pyxb.namespace.ExpandedName(Namespace, "messageId")),
        pyxb.utils.utility.Location("/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 31, 3),
    )
    st_4 = fac.State(
        symbol,
    ...
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        headerType._UseForTag(pyxb.namespace.ExpandedName(Namespace, "messageType")),
        pyxb.utils.utility.Location("/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 37, 3),
    )
    st_10 = fac.State(
        symbol,
    ...
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        headerType._UseForTag(pyxb.namespace.ExpandedName(Namespace, "subMessageType")),
        pyxb.utils.utility.Location("/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 38, 3),
    )
    st_11 = fac.State(
        symbol,
    ...
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        headerType._UseForTag(pyxb.namespace.ExpandedName(Namespace, "subject")),
        pyxb.utils.utility.Location("/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 41, 3),
    )
    st_14 = fac.State(
        symbol,
    ...
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        headerType._UseForTag(pyxb.namespace.ExpandedName(Namespace, "comment")),
        pyxb.utils.utility.Location("/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 42, 3),
    )
    st_15 = fac.State(
        symbol,
    ...
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        headerType._UseForTag(pyxb.namespace.ExpandedName(Namespace, "messageDate")),
        pyxb.utils.utility.Location("/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 43, 3),
    )
    st_16 = fac.State(
        symbol,
    ...
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        headerType._UseForTag(pyxb.namespace.ExpandedName(Namespace, "eventDate")),
        pyxb.utils.utility.Location("/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 45, 3),
    )
    st_18 = fac.State(
        symbol,
    ...
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        headerType._UseForTag(pyxb.namespace.ExpandedName(Namespace, "action")),
        pyxb.utils.utility.Location("/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 47, 3),
    )
    st_20 = fac.State(
        symbol,
    ...
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        headerType._UseForTag(pyxb.namespace.ExpandedName(Namespace, "attachment")),
        pyxb.utils.utility.Location("/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 48, 3),
    )
    st_21 = fac.State(
        symbol,
    ...
    symbol = pyxb.binding.content.ElementUse(
        headerType._UseForTag(pyxb.namespace.ExpandedName(Namespace, "namedMetaData")),
        pyxb.utils.utility.Location("/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 52, 3),
    )
    st_25 = fac.State(
        symbol,
    ...
    symbol = pyxb.binding.content.ElementUse(
        headerType._UseForTag(pyxb.namespace.ExpandedName(Namespace, "extension")),
        pyxb.utils.utility.Location("/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 53, 3),
    )
    st_26 = fac.State(
        symbol,
    ...
    transitions = []
    transitions.append(fac.Transition(st_13, [fac.UpdateInstruction(cc_9, True)]))
    ...
    transitions = []
    transitions.append(fac.Transition(st_14, [fac.UpdateInstruction(cc_10, True)]))
    ...
    transitions = []
    transitions.append(fac.Transition(st_15, [fac.UpdateInstruction(cc_11, True)]))
    ...
    transitions = []
    transitions.append(fac.Transition(st_17, [fac.UpdateInstruction(cc_12, True)]))
    ...
    transitions = []
    transitions.append(fac.Transition(st_18, [fac.UpdateInstruction(cc_13, True)]))
    ...
    transitions = []
    transitions.append(fac.Transition(st_19, [fac.UpdateInstruction(cc_14, True)]))
    ...
    transitions = []
    transitions.append(fac.Transition(st_21, [fac.UpdateInstruction(cc_15, True)]))
    ...
    transitions = []
    transitions.append(fac.Transition(st_23, [fac.UpdateInstruction(cc_16, True)]))
    ...
    transitions = []
    transitions.append(fac.Transition(st_24, [fac.UpdateInstruction(cc_17, True)]))
    ...
    transitions = []
    transitions.append(fac.Transition(st_25, [fac.UpdateInstruction(cc_18, True)]))
    transitions.append(fac.Transition(st_26, [fac.UpdateInstruction(cc_18, False)]))
    st_25._set_transitionSet(transitions)
    transitions = []
    transitions.append(fac.Transition(st_26, [fac.UpdateInstruction(cc_19, True)]))
...
partialDeliveryType._AddElement(
    pyxb.binding.basis.element(
        pyxb.namespace.ExpandedName(Namespace, "uniqueIdDelivery"),
        uniqueIdDeliveryType,
        scope=partialDeliveryType,
        location=pyxb.utils.utility.Location(
            "/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 73, 3
        ),
    )
)
...
partialDeliveryType._AddElement(
    pyxb.binding.basis.element(
        ...
        scope=partialDeliveryType,
        location=pyxb.utils.utility.Location(
            "/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 74, 3
        ),
    )
)
...
partialDeliveryType._AddElement(
    pyxb.binding.basis.element(
        ...
        scope=partialDeliveryType,
        location=pyxb.utils.utility.Location(
            "/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 75, 3
        ),
    )
)
...
def _BuildAutomaton_2():
    ...
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        partialDeliveryType._UseForTag(
            pyxb.namespace.ExpandedName(Namespace, "uniqueIdDelivery")
        ),
        pyxb.utils.utility.Location("/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 73, 3),
    )
...
sendingApplicationType._AddElement(
    pyxb.binding.basis.element(
        pyxb.namespace.ExpandedName(Namespace, "manufacturer"),
        STD_ANON_2,
        scope=sendingApplicationType,
        location=pyxb.utils.utility.Location(
            "/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 167, 3
        ),
    )
)
...
sendingApplicationType._AddElement(
    pyxb.binding.basis.element(
        ...
        scope=sendingApplicationType,
        location=pyxb.utils.utility.Location(
            "/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 175, 3
        ),
    )
)
...
sendingApplicationType._AddElement(
    pyxb.binding.basis.element(
        ...
        scope=sendingApplicationType,
        location=pyxb.utils.utility.Location(
            "/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 183, 3
        ),
    )
)
...
def _BuildAutomaton_3():
    ...
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        sendingApplicationType._UseForTag(
            pyxb.namespace.ExpandedName(Namespace, "manufacturer")
        ),
        pyxb.utils.utility.Location("/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 167, 3),
    )
...
infoType._AddElement(
    pyxb.binding.basis.element(
        pyxb.namespace.ExpandedName(Namespace, "positiveReport"),
        CTD_ANON,
        scope=infoType,
        location=pyxb.utils.utility.Location(
            "/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 195, 3
        ),
    )
)
...
infoType._AddElement(
    pyxb.binding.basis.element(
        ...
        scope=infoType,
        location=pyxb.utils.utility.Location(
            "/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 203, 3
        ),
    )
)
...
def _BuildAutomaton_4():
    ...
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(
        infoType._UseForTag(pyxb.namespace.ExpandedName(Namespace, "positiveReport")),
        pyxb.utils.utility.Location("/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 195, 3),
    )
    st_0 = fac.State(
        symbol,
    ...
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(
        infoType._UseForTag(pyxb.namespace.ExpandedName(Namespace, "negativeReport")),
        pyxb.utils.utility.Location("/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 203, 3),
    )
    st_1 = fac.State(
        symbol,
...
CTD_ANON._AddElement(
    pyxb.binding.basis.element(
        ...
        scope=CTD_ANON,
        location=pyxb.utils.utility.Location(
            "/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 198, 6
        ),
    )
)
...
CTD_ANON._AddElement(
    pyxb.binding.basis.element(
        ...
        scope=CTD_ANON,
        location=pyxb.utils.utility.Location(
            "/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 199, 6
        ),
    )
)
...
def _BuildAutomaton_5():
    ...
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(
        CTD_ANON._UseForTag(pyxb.namespace.ExpandedName(Namespace, "notice")),
        pyxb.utils.utility.Location("/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 198, 6),
    )
    st_0 = fac.State(
        symbol,
    ...
    symbol = pyxb.binding.content.ElementUse(
        CTD_ANON._UseForTag(pyxb.namespace.ExpandedName(Namespace, "data")),
        pyxb.utils.utility.Location("/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 199, 6),
    )
    st_1 = fac.State(
        symbol,
...
CTD_ANON_._AddElement(
    pyxb.binding.basis.element(
        ...
        scope=CTD_ANON_,
        location=pyxb.utils.utility.Location(
            "/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 206, 6
        ),
    )
)
...
CTD_ANON_._AddElement(
    pyxb.binding.basis.element(
        ...
        scope=CTD_ANON_,
        location=pyxb.utils.utility.Location(
            "/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 207, 6
        ),
    )
)
...
def _BuildAutomaton_6():
    ...
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(
        CTD_ANON_._UseForTag(pyxb.namespace.ExpandedName(Namespace, "notice")),
        pyxb.utils.utility.Location("/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 206, 6),
    )
    st_0 = fac.State(
        symbol,
    ...
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(
        CTD_ANON_._UseForTag(pyxb.namespace.ExpandedName(Namespace, "data")),
        pyxb.utils.utility.Location("/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 207, 6),
    )
    st_1 = fac.State(
        symbol,
...
CTD_ANON_2._AddElement(
    pyxb.binding.basis.element(
        ...
        scope=CTD_ANON_2,
        location=pyxb.utils.utility.Location(
            "/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 216, 4
        ),
    )
)
...
CTD_ANON_2._AddElement(
    pyxb.binding.basis.element(
        ...
        scope=CTD_ANON_2,
        location=pyxb.utils.utility.Location(
            "/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 217, 4
        ),
    )
)
...
def _BuildAutomaton_7():
    ...
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        CTD_ANON_2._UseForTag(pyxb.namespace.ExpandedName(Namespace, "header")),
        pyxb.utils.utility.Location("/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 216, 4),
    )
    st_0 = fac.State(
        symbol,
    ...
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(
        CTD_ANON_2._UseForTag(pyxb.namespace.ExpandedName(Namespace, "info")),
        pyxb.utils.utility.Location("/app/ebau_gwr/core/xsd/ech_0058_5_0.xsd", 217, 4),
    )
    st_1 = fac.State(
        symbol,
